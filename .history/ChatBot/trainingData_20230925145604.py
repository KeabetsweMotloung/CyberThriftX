...
tokenized_pattern=[stem(token_pattern) for token_pattern in tokenized_pattern if token_pattern not in blind_Characters]for stem(token_pattern) in tokenized_pattern :
    if 